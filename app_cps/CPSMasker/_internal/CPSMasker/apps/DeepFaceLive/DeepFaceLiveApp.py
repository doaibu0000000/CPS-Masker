...
class QDFLAppWindow(qtx.QXWindow):
    ...
    def __init__(self, userdata_path, settings_dirpath):
        ...
        menu_language_action_english = menu_language.addAction('Indonesia' )
        ...
        menu_help_action_github.triggered.connect(lambda: qtx.QDesktopServices.openUrl(qtx.QUrl('https://github.com/doaibu0000000' )))
...
class DeepFaceLiveApp(qtx.QXMainApplication):
    def __init__(self, userdata_path):
        ...
        super().__init__(app_name='CPS Masker', settings_dirpath=settings_dirpath)
